...
void appartient ( int nb, tas t, char boo [MAX],char flag)
{
  int i;
  if (flag == 0 )
    for (i = 0; i < MAX; i++)
  ...
  boo[t->n] = 1;
  appartient(nb,t->suc[0],boo,flag);
  appartient(nb,t->suc[1],boo,flag);
  appartient(nb,t->suc[2],boo,flag);
}
